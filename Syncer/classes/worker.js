...
var conveyorResolver_1 = require("./conveyorResolver");
...
var Syncer = /** @class */ (function () {
    ...
    Syncer.prototype.tick = function () {
        return __awaiter(this, void 0, void 0, function () {
            var i, currentConnection, currentOperation, e_2, variablesToUpdate, e_3, productUiResolver;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        i = 0;
                        _a.label = 1;
                    case 1:
                        if (!(i < this.connections.length)) return [3 /*break*/, 19];
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 6];
                    case 6:
                        variablesToUpdate = null;
                        if (!currentConnection) return [3 /*break*/, 10];
                        _a.label = 7;
                    case 7:
                        _a.trys.push([7, 9, , 10]);
                        return [4 /*yield*/, this.read(currentConnection)];
                    case 8:
                    ...
                    case 14:
                        ...
                        return [4 /*yield*/, conveyorResolver_1.ConveyorResolverSingleton.resolveConveyors(currentConnection.plc.variablesToReadOnly)];
                    case 15:
                        //read conveyor states
                        _a.sent();
                        // loadedTestData=true;
                    ...
                    case 16:
                        ...
                        //try to declare operation a success (triggers will either confirm it or not)
                        _a.sent();
                        if (!variablesToUpdate) return [3 /*break*/, 18];
    ...
    Syncer.prototype.updateDatabase = function (connection, variablesToUpdate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var dataToInsert, returnedData, e_4;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
    ...
    Syncer.prototype.operationProcessor = function (allInPending, newOperations) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var toDeclareSuccessfull, returnedData, e_5, newOpps, modOpps, delOpps, toCreate, returnedData, e_6;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
