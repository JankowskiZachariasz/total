...
var ProductUtil = /** @class */ (function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 8:
                                    ...
                                    return [4 /*yield*/, paczka_1["default"].bulkWrite(diff.toModify.map(function (doc) { return ({
                                            'updateOne': {
                                                'filter': { '_id': doc._id },
                                                'update': { '$set': doc },
                                                'upsert': true
    ...
    ProductUtil.prototype.buildProducts = function (paczkas) {
        ...
        Object.keys(map).map(function (key) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_x) {
                a = (((_a = map[key][0]) === null || _a === void 0 ? void 0 : _a.plcId) > 0 && ((_b = map[key][0]) === null || _b === void 0 ? void 0 : _b.plcId) <= 400) ? (1) : (0);
                b = (((_c = map[key][1]) === null || _c === void 0 ? void 0 : _c.plcId) > 0 && ((_d = map[key][1]) === null || _d === void 0 ? void 0 : _d.plcId) <= 400) ? (1) : (0);
                c = (((_e = map[key][2]) === null || _e === void 0 ? void 0 : _e.plcId) > 0 && ((_f = map[key][2]) === null || _f === void 0 ? void 0 : _f.plcId) <= 400) ? (1) : (0);
                ...
                toReturn.push({
                    ...
                    series1: (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny1) ? ((notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny1) > 32767 ? (32767) : ((notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny1) < 0 ? (0) : (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny1))) : (0),
                    series2: (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny2) ? ((notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny2) > 32767 ? (32767) : ((notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny2) < 0 ? (0) : (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny2))) : (0),
                    series3: (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny3) ? ((notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny3) > 32767 ? (32767) : ((notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny3) < 0 ? (0) : (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny3))) : (0),
                    count: a + b + c,
                    length1: ((_g = map[key][0]) === null || _g === void 0 ? void 0 : _g.lPaczek) > 32767 ? (32767) : (((_h = map[key][0]) === null || _h === void 0 ? void 0 : _h.lPaczek) < 0 ? (0) : ((_j = map[key][0]) === null || _j === void 0 ? void 0 : _j.lPaczek)),
                    length2: ((_k = map[key][1]) === null || _k === void 0 ? void 0 : _k.lPaczek) > 32767 ? (32767) : (((_l = map[key][1]) === null || _l === void 0 ? void 0 : _l.lPaczek) < 0 ? (0) : ((_m = map[key][1]) === null || _m === void 0 ? void 0 : _m.lPaczek)),
                    length3: ((_o = map[key][2]) === null || _o === void 0 ? void 0 : _o.lPaczek) > 32767 ? (32767) : (((_p = map[key][2]) === null || _p === void 0 ? void 0 : _p.lPaczek) < 0 ? (0) : ((_q = map[key][2]) === null || _q === void 0 ? void 0 : _q.lPaczek)),
                    plcId1: (_r = map[key][0]) === null || _r === void 0 ? void 0 : _r.plcId,
                    plcId2: (_s = map[key][1]) === null || _s === void 0 ? void 0 : _s.plcId,
                    plcId3: (_t = map[key][2]) === null || _t === void 0 ? void 0 : _t.plcId,
                    toDelete: false,
                    wasUpdatedByClient: false,
                    name: ((_u = notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny1) === null || _u === void 0 ? void 0 : _u.toString()) + ((_v = notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny2) === null || _v === void 0 ? void 0 : _v.toString()) + ((_w = notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny3) === null || _w === void 0 ? void 0 : _w.toString())
                        + ' ' + (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny1) + '-' + (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny2) + '-' + (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny3) //hyphens
                        + ' ' + (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny1) + ' ' + (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny2) + ' ' + (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.nrSeryjny3) //spaces
                        + ' ' + (notnullPaczka === null || notnullPaczka === void 0 ? void 0 : notnullPaczka.name)
                });
                return [2 /*return*/];
            });
        }); });
    ...
    ProductUtil.prototype.CommitProducts = function (diff) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var localDelete, e_6, localAdd, e_7, err_2;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    localDelete = [];
                                ...
                                case 8:
                                    _a.trys.push([8, 10, , 11]);
                                    return [4 /*yield*/, products_1["default"].bulkWrite(diff.toModify.map(function (doc) { return ({
                                            'updateOne': {
                                                'filter': { '_id': doc._id },
                                                'update': { '$set': doc },
                                                'upsert': true
    ...
    ProductUtil.prototype.deleteToDelete = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            products_1["default"].deleteMany({ 'toDelete': true }, function (err, result) {
                                if (err) {
                                    console.log(err);
                                    reject();
                                }
